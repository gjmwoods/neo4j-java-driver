...
public class LocalNettyChannelPool implements ExtendedChannelPool {
    /**
    ...
    private String poolId(LocalAddress serverAddress) {
        return String.format("%s-%d", serverAddress.id(), this.hashCode());
    }
}
