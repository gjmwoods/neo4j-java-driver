...
public class LocalProxyToRemoteHandler extends ChannelInboundHandlerAdapter {

    private final Channel localChannel;

    public LocalProxyToRemoteHandler(Channel localChannel) {
    ...
    public void channelInactive(ChannelHandlerContext ctx) {
        LocalToRemoteProxy.flushThenClose(localChannel);
    }
