 ...
 */
package org.neo4j.connector.messaging;
...
public interface BoltProtocol
{
    ...
    /**
     * Execute the given query in an auto-commit transaction, i.e. //todo sessionLink { Session#run(Query)}.
     *
    ...
    /**
     * Execute the given query in a running unmanaged transaction, i.e. todo link @link Transaction#run(Query)}.
     *
     * @param connection the network connection to use.
     * @param query the cypher to execute.
