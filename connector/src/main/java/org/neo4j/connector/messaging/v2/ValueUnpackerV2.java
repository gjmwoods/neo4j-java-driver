 ...
 */
package org.neo4j.connector.messaging.v2;
...
import static org.neo4j.connector.messaging.v2.MessageFormatV2.DATE;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.DATE_STRUCT_SIZE;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.DATE_TIME_STRUCT_SIZE;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.DATE_TIME_WITH_ZONE_ID;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.DATE_TIME_WITH_ZONE_OFFSET;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.DURATION;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.DURATION_TIME_STRUCT_SIZE;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.LOCAL_DATE_TIME;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.LOCAL_DATE_TIME_STRUCT_SIZE;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.LOCAL_TIME;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.LOCAL_TIME_STRUCT_SIZE;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.POINT_2D_STRUCT_SIZE;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.POINT_2D_STRUCT_TYPE;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.POINT_3D_STRUCT_SIZE;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.POINT_3D_STRUCT_TYPE;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.TIME;
import static org.neo4j.connector.messaging.v2.MessageFormatV2.TIME_STRUCT_SIZE;
...
public class ValueUnpackerV2 extends ValueUnpackerV1
{
    ...
    private Value unpackLocalDateTime() throws IOException
    {
        ...
        return Values.value( LocalDateTime.ofEpochSecond( epochSecondUtc, nano, UTC ) );
    }
    ...
    private Value unpackDateTimeWithZoneOffset() throws IOException
    {
        ...
        int nano = Math.toIntExact( unpacker.unpackLong() );
        int offsetSeconds = Math.toIntExact( unpacker.unpackLong() );
        return Values.value( newZonedDateTime( epochSecondLocal, nano, ZoneOffset.ofTotalSeconds( offsetSeconds ) ) );
    }
    ...
    private Value unpackDateTimeWithZoneId() throws IOException
    {
        ...
        return Values.value( newZonedDateTime( epochSecondLocal, nano, ZoneId.of( zoneIdString ) ) );
    }
