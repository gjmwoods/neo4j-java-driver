 ...
 */
package org.neo4j.connector.async.outbound;
...
import static org.neo4j.connector.async.connection.BoltProtocolUtil.CHUNK_HEADER_SIZE_BYTES;
import static org.neo4j.connector.async.connection.BoltProtocolUtil.DEFAULT_MAX_OUTBOUND_CHUNK_SIZE_BYTES;
...
public class ChunkAwareByteBufOutput implements PackOutput
{
    ...
    public ChunkAwareByteBufOutput( int maxChunkSize )
    {
