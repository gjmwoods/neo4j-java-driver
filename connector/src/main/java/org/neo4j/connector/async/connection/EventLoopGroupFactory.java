 ...
 */
package org.neo4j.connector.async.connection;
...
public final class EventLoopGroupFactory
{
     ...
     * blocking API methods like {\\todo @link Session#run(String)} are implemented on top of corresponding async API methods
     * like \\todo @link AsyncSession#runAsync(String)} using basically {@link Future#get()} calls. Deadlocks might happen when IO
