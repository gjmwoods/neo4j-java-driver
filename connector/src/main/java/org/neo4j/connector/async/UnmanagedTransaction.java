...
public class UnmanagedTransaction
{
    private enum State
    {
        ...
        /**
         * This transaction has been terminated either because of explicit \\todo sessionLink {Session#reset()} or because of a
    ...
    private CompletionStage<Void> doCommitAsync()
    {
        ...
        {
            return Futures.failedFuture( new ClientException( "Transaction can't be committed. " +
