 ...
 */
package org.neo4j.connector.logging;
...
import org.neo4j.connector.internal.util.Format;
...
public class ChannelActivityLogger extends ReformattedLogger
{
    ...
    public String reformat( String message )
    {
        ...
        return String.format( "[0x%s][%s][%s] %s", localChannelId, Format.valueOrEmpty( serverAddress ), Format.valueOrEmpty( dbConnectionId ), message );
    }
